...
"Escolha a sua seção:"
        ...
        Console.WriteLine(
"1 - Consulta ordenado de um colaborador"
);
        Console.WriteLine(
"2 - Consulta subsídio de alimentação"
);
        Console.WriteLine(
"0 - Voltar ao menu de secções"
);
...
"Escolha a sua seção:"
        ...
        Console.WriteLine(
"1 - Listagem dos colaboradores inscritos no seguro de saúde"
);
        Console.WriteLine(
            ...
            :
...

                    {
                        ...
                        :
                                Console.Clear();
                                Console.WriteLine(
"Quantos colaboradores devem ser criados?"
);

                                int
                                 nColabs = Convert.ToInt32(Console.ReadLine());
                        ...
                        :
                                ...
                                Console.Clear();
                                Console.WriteLine(
"Digite o código ou o nome de um colaborador para fazer a pesquisa:"
);
                        ...
                        :
                                Console.WriteLine();
                                Console.WriteLine(
"Escolha somente uma das opções mostradas."
);
                                Thread.Sleep(
1200
);
            ...
            2
            :
                    //Consulta ordenados e subsídios
...

                    {
                        ...
                        :
                                ...
                                Console.Clear();
                                Console.WriteLine(
"Digite o código do colaborador para fazer a consulta"
);
